""" Test model managers in snuniversities
    python manage.py test snuniversities.tests.test_managers
"""

from django.test import TestCase
from snuniversities.constants.application_requirements import INTERVIEW_REQUIRED, NOT_OFFERED
from snuniversities.constants.application_tracker_status import NONE, OPTIONAL, REQUIRED
