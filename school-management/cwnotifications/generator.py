...
from cwnotifications.models import Notification, NotificationModelManager, NotificationRecipient
from cwnotifications.activity_log_descriptions import ACTIVITY_LOG_DESCRIPTION_FUNCTIONS, ACTIVITY_LOG_TITLE_FUNCTIONS
