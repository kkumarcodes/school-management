""" Tests to ensure we generate automated notifications/reminders in the correct circumstances
    python manage.py test cwnotifications.tests.test_automated_notifications
"""
import json
...
from cwnotifications.mailer import get_first_individual_tutoring_session_digest_details
from cwnotifications.models import Notification
from cwnotifications.tasks import (
...
class TestTaskNotifications(TestCase):
    ...
    def test_sending_tutors_daily_digest_emails(self):
        """ python manage.py test cwnotifications.tests.test_automated_notifications:TestTaskNotifications.test_sending_tutors_daily_digest_emails """
    ...
    def test_first_individual_tutoring_session_daily_digest(self):
        """
        python manage.py test cwnotifications.tests.test_automated_notifications:TestTaskNotifications.test_first_individual_tutoring_session_daily_digest -s
        """
...
class TestUserNotifications(TestCase):
    """ python manage.py test cwnotifications.tests.test_automated_notifications:TestUserNotifications """
