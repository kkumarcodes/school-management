"""
  python manage.py test snmessages.tests.test_tasks
  Test snmessages.tasks
"""
...
from snmessages.tasks import send_unread_messages, UNREAD_MESSAGE_DELAY
...
class TestUnreadMessagesNotification(TestCase):
    ...
    def test_successful_notifications(self):
        """ python manage.py test snmessages.tests.test_tasks:TestUnreadMessagesNotification.test_successful_notifications
        """
    ...
    def test_successful_notifications_counselor(self):
        """ Lightweight test to ensure counselors get notified of new student messages
            python manage.py test snmessages.tests.test_tasks:TestUnreadMessagesNotification.test_successful_notifications_counselor
