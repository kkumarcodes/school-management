...
from snnotifications.views.notification import NotificationRecipientViewset, CreateNotificationView, ActivityLogView
from snnotifications.views.bulletin import BulletinViewset
