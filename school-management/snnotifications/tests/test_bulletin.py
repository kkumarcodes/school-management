""" Test creation, sending, and filtering of bulletins
    ...
    python manage.py test snnotifications.tests.test_bulletin
"""
...
from snnotifications.models import Bulletin, Notification, NotificationRecipient
...
class TestBulletinManager(TestCase):
    """ python manage.py test snnotifications.tests.test_bulletin:TestBulletinManager """
    ...
    def test_evergreen(self):
        """ Test to ensure evergreen bulletins get properly set on new students and counselors
            python manage.py test snnotifications.tests.test_bulletin:TestBulletinManager.test_evergreen
        """
