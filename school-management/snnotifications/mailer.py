...
from snnotifications.constants.constants import NOTIFICATIONS_FOR_PENDING_USERS, get_notification_config
from snnotifications.models import Notification
from sntasks.models import Task
from sntutoring.models import GroupTutoringSession, StudentTutoringSession, TutoringPackage
...
def send_email_for_notification(notification: Notification, resend=True, force_test=False):
    ...
    template_file = f"snnotifications/email_templates/{template_name}.html"
