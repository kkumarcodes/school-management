...
from sncommon.mixins import AdminContextMixin, CSVMixin
...
from sntutoring.serializers.diagnostics import (
...
from sntutoring.serializers.tutoring_sessions import LocationSerializer
from sntutoring.utilities.diagnostic_result_manager import DiagnosticResultManager
...
class DiagnosticLandingPageView(TemplateView):
    ...
    template_name = "sntutoring/diagnostic_landing_page.html"
