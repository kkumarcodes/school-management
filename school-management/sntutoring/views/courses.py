...
from sntutoring.models import Course
from sntutoring.serializers.tutoring_sessions import CourseSerializer
from sntutoring.utilities.tutoring_session_manager import (
...
class CourseLandingPageView(TemplateView):
    template_name = "sntutoring/course_landing_page.html"
