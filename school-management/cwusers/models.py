...
class Student(CommonUser):
    ...
    visible_resources = models.ManyToManyField("cwresources.Resource", related_name="visible_students", blank=True)
    visible_resource_groups = models.ManyToManyField(
        "cwresources.ResourceGroup", related_name="visible_students", blank=True
    )

    location = models.ForeignKey(
        "cwtutoring.Location", related_name="students", on_delete=models.PROTECT, default=get_default_location,
    )
    ...
    applied_roadmaps = models.ManyToManyField("cwcounseling.Roadmap", related_name="students", blank=True)
...
class Tutor(CommonUser, ZoomFields):
    ...
    university = models.ForeignKey(
        "cwuniversities.University", related_name="tutors", null=True, blank=True, on_delete=models.SET_NULL,
    )
...
class Counselor(CommonUser, ZoomFields):
    ...
    location = models.ForeignKey(
        "cwtutoring.Location", related_name="counselors", on_delete=models.PROTECT, default=get_default_location,
    )
