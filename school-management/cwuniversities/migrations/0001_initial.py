    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('universities', models.ManyToManyField(blank=True, related_name='university_lists', to='cwuniversities.university')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deadline', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='student_university_decisions', to='cwuniversities.deadline')),
            ],
        ),
    ]
