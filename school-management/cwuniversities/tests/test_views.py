""" Test cwuniversities.views
    python manage.py test cwuniversities.tests.test_views
"""
import json
...
from cwuniversities.models import (
    Deadline,
    DeadlineCategory,
    DeadlineType,
...
class TestDeadlineAndDecisionViewsets(TestCase):
    """ python manage.py test cwuniversities.tests.test_views:TestDeadlineAndDecisionViewsets """
    ...
    def test_deadlines(self):
        """ python manage.py test cwuniversities.tests.test_views:TestDeadlineAndDecisionViewsets.test_deadlines """
        data = {
    ...
    def test_decisions(self):
        """ python manage.py test cwuniversities.tests.test_views:TestDeadlineAndDecisionViewsets.test_decisions """
        data = {
...
class TestUniversityViewset(TestCase):
    """ python manage.py test cwuniversities.tests.test_views:TestUniversityViewset """
...
class TestUniversityListViewset(TestCase):
    """ python manage.py test cwuniversities.tests.test_views:TestUniversityListViewset """
    ...
    def test_authentication(self):
        """ python manage.py test cwuniversities.tests.test_views:TestUniversityListViewset.test_authentication """
    ...
    def test_create(self):
        """ python manage.py test cwuniversities.tests.test_views:TestUniversityListViewset.test_create """
    ...
    def test_update(self):
        """ python manage.py test cwuniversities.tests.test_views:TestUniversityListViewset.test_update """
    ...
    def test_read(self):
        """ python manage.py test cwuniversities.tests.test_views:TestUniversityListViewset.test_read """
...
class TestCWUniversityDataView(TestCase):
    """ python manage.py test cwuniversities.tests.test_views:TestCWUniversityDataView """
