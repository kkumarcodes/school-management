""" Test our views and utilities for interfacing with Magento
    python manage.py test cwcommon.tests.test_magento
    python manage.py test cwcommon.tests.test_magento:TestMagentoPurchaseWebhook.test_ambiguous_package
"""
import json
...
from cwcounseling.models import CounselingHoursGrant, CounselingPackage, CounselorTimeEntry
from cwnotifications.constants.notification_types import CAP_MAGENTO_STUDENT_CREATED, INVITE
...
TEST_CAP_PAYLOAD = "cwcommon/tests/cap_magento_payload.json"
TEST_SELF_ENROLL_PAYLOAD = "cwcommon/tests/magento_self_enrollment_payload.json"
...
class TestMagentoCounselingSelfEnrollment(TestCase):
    """ This tests counseling self-enrollments
        ...
        python manage.py test cwcommon.tests.test_magento:TestMagentoCounselingSelfEnrollment
    """
...
class TestMagentoPurchaseWebhook(TestCase):
    """ This tests all scenarios for non self-enrollment payloads
        python manage.py test cwcommon.tests.test_magento:TestMagentoPurchaseWebhook
    """
    ...
    def test_counseling_product(self):
        """ python manage.py test cwcommon.tests.test_magento:TestMagentoPurchaseWebhook.test_counseling_product
        """
    ...
    def test_counseling_paygo(self):
        """ Test that paygo hours get added to a student using cap_magento_payload
            python manage.py test cwcommon.tests.test_magento:TestMagentoPurchaseWebhook.test_counseling_paygo
        """
    ...
    def test_counseling_package(self):
        """ Test that when we see a counseling package for a part-time counselor
            ...
            python manage.py test cwcommon.tests.test_magento:TestMagentoPurchaseWebhook.test_counseling_package
        """
...
#     """ python manage.py test cwcommon.tests.test_magento:TestPaygoChargeTask
#         Test cwcommon.tasks.charge_paygo_sessions
#     """
...
#         python manage.py test cwcommon.tests.test_magento:TestMagentoPaygoAPI.test_view
#     """
