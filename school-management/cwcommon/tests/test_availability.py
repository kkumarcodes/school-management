""" Test availability manager and views (for tutors and counselors)
    python manage.py test cwcommon.tests.test_availability
"""
import json
import random
...
from cwcommon.models import BaseRecurringAvailability, get_default_locations
...
class TestRecurringAvailabilityView(TestCase):
    """ python manage.py test cwcommon.tests.test_availability:TestRecurringAvailabilityView
    """
...
class TestAvailabilityViewset(TestCase):
    """
        python manage.py test cwcommon.tests.test_availability:TestAvailabilityViewset
    ...
    def test_filter_location(self):
        """ Test filtering availability (not recurring) on location. Includes testing retreiving recurring
            ...
            python manage.py test cwcommon.tests.test_availability:TestAvailabilityViewset.test_filter_location
        """
        availabilities = self.availabilities["tutor"]
        self.client.force_login(self.tutor.user)
    ...
    def test_create_update(self):
        """ Test creating/updating availability as a tutor and as an administrator
            python manage.py test cwcommon.tests.test_availability:TestAvailabilityViewset.test_create_update
        """
        for cw_user in (self.tutor, self.counselor):
...
class TestEmptyRecurringAvailability(TestCase):
    """
        python manage.py test cwcommon.tests.test_availability_views:TestEmptyRecurringAvailability
...
class TestRecurringAvailability(TestCase):
    """ Test to make sure recurring availability functions properly, especially around the edges
        of our trimesters
        python manage.py test cwcommon.tests.test_availability:TestRecurringAvailability
    """
    ...
    def test_filter_recurring_availability_on_location(self):
        """ python manage.py test cwcommon.tests.test_availability:TestRecurringAvailability.test_filter_recurring_availability_on_location """
        for cw_user in (self.tutor, self.counselor):
...
class TestAvailability(TestCase):
    """ Simple tests for get_availability that don't do anything fancy with recurring
        ...
        python manage.py test cwcommon.tests.test_availability:TestAvailability
    """
    ...
    def test_availability_max_meetings(self):
        """ Confirm that Counselor.max_meetings_per_day constraint works
            python manage.py test cwcommon.tests.test_availability:TestAvailability.test_availability_max_meetings
        """
        availability = CounselorAvailability.objects.create(
    ...
    def test_buffer_between_meetings(self):
        """ python manage.py test cwcommon.tests.test_availability:TestAvailability.test_buffer_between_meetings """
        now = timezone.now()
