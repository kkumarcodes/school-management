...
from cwtutoring.constants import RECURRING_AVAILABILITY_FALL_START_MONTH, RECURRING_AVAILABILITY_SUMMER_START_MONTH
...
class FileUpload(CWModel):
    ...
    task = models.ForeignKey(
        "cwtasks.Task", related_name="file_uploads", null=True, blank=True, on_delete=models.SET_NULL
    )

    diagnostic_result = models.ForeignKey(
        "cwtutoring.DiagnosticResult", related_name="file_uploads", null=True, blank=True, on_delete=models.SET_NULL
    )

    bulletin = models.ForeignKey(
        "cwnotifications.Bulletin", related_name="file_uploads", null=True, blank=True, on_delete=models.SET_NULL
    )
    ...
    counselor_meeting = models.ForeignKey(
        "cwcounseling.CounselorMeeting", related_name="file_uploads", null=True, blank=True, on_delete=models.SET_NULL
    )

    test_result = models.ForeignKey(
        "cwtutoring.TestResult", related_name="file_uploads", null=True, blank=True, on_delete=models.SET_NULL
    )
