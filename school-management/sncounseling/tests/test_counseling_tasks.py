""" Tests for our sncounseling celery tasks (sncounseling.tasks)
    python manage.py test sncounseling.tests.test_counseling_tasks
"""
...
from sncounseling.tasks import send_counselor_completed_task_digest, send_counselor_task_digest
...
class TestCounselorCompletedTaskDigest(TestCase):
    """ python manage.py test sncounseling.tests.test_counseling_tasks:TestCounselorCompletedTaskDigest
    """
...
class TestCounselorTaskDigest(TestCase):
    ...
    def test_send_hour(self):
        """ python manage.py test sncounseling.tests.test_counseling_tasks:TestCounselorTaskDigest.test_send_hour
        """
