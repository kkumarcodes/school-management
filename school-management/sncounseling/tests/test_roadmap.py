""" python manage.py test sncounseling.tests.test_roadmap
"""
...
from sncounseling.models import AgendaItem, AgendaItemTemplate, CounselorMeetingTemplate, Roadmap
...
class TestRoadmapCrud(TestCase):
    """
    python manage.py test sncounseling.tests.test_roadmap:TestRoadmapCrud
    """
...
class TestRoadmapApply(TestCase):
    """ python manage.py test sncounseling.tests.test_roadmap:TestRoadmapApply
    """
    ...
    def test_custom_apply_to_student(self):
        """ python manage.py test sncounseling.tests.test_roadmap:TestRoadmapApply.test_custom_apply_to_student
        """
        self.client.force_login(self.counselor.user)
...
class TestRoadmapUnapply(TestCase):
    """ python manage.py test sncounseling.tests.test_roadmap:TestRoadmapUnapply
    """
