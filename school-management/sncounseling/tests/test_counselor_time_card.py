""" Test CRUD and proper permissions on CounselorTimeEntry
    python manage.py test sncounseling.tests.test_counselor_time_card
"""
import decimal
import json
import random
...
from sncounseling.models import CounselingHoursGrant, CounselorTimeCard, CounselorTimeEntry
from sncounseling.utilities.counselor_time_card_manager import (
...
class TestCounselingHoursGrantViewset(TestCase):
    # python manage.py test sncounseling.tests.test_counselor_time_card:TestCounselingHoursGrantViewset
...
class TestCounselorTimeEntry(TestCase):
    # python manage.py test sncounseling.tests.test_counselor_time_card:TestCounselorTimeEntry
    fixtures = ("fixture.json",)
    ...
    def test_determine_pay_rate(self):
        """ Test that we determine pay rate using:
            ...
            python manage.py test sncounseling.tests.test_counselor_time_card:TestCounselorTimeEntry.test_determine_pay_rate
        """
...
class TestCounselorTimeCardManager(TestCase):
    ...
    # python manage.py test sncounseling.tests.test_counselor_time_card:TestCounselorTimeCardManager
    fixtures = ("fixture.json",)
...
class TestCounselorTimeCardView(TestCase):
    # python manage.py test sncounseling.tests.test_counselor_time_card:TestCounselorTimeCardView
...
class TestStudentCounselingHoursViewset(TestCase):
    # python manage.py test sncounseling.tests.test_counselor_time_card:TestStudentCounselingHoursViewset
