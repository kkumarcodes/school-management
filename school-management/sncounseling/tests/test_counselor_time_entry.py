""" Test CRUD and proper permissions on CounselorTimeEntry
    python manage.py test sncounseling.tests.test_counselor_time_entry
"""
import decimal
import json
...
from sncounseling.models import CounselorTimeEntry
from snusers.models import Administrator, Counselor, Student


class TestCounselorTimeEntry(TestCase):
    # python manage.py test sncounseling.tests.test_counselor_time_entry:TestCounselorTimeEntry -s
