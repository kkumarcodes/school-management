""" python manage.py test sncounseling.tests.test_counselor_meetings
"""
...
from sncounseling.constants import counselor_time_entry_category
from sncounseling.utilities.roadmap_manager import RoadmapManager
from sncounseling.models import (
    AgendaItem,
    AgendaItemTemplate,
...
from sncounseling.utilities.counselor_meeting_manager import CounselorMeetingManager, CounselorMeetingManagerException
from sncounseling.fixtures.roadmaps import import_roadmap
...
class TestCounselorMeetingViewset(TestCase):
    """ python manage.py test sncounseling.tests.test_counselor_meetings:TestCounselorMeetingViewset
    """
...
class TestCounselorMeetingTemplateView(TestCase):
    """ python manage.py test sncounseling.tests.test_counselor_meetings:TestCounselorMeetingTemplateView
    """
...
class TestAgendaItemViews(TestCase):
    """ Tests views for agenda items and agenda item templates
        python manage.py test sncounseling.tests.test_counselor_meetings:TestAgendaItemViews
    """
...
class TestAgendaItemTemplateViewset(TestCase):
    """ python manage.py test sncounseling.tests.test_counselor_meetings:TestAgendaItemTemplateViewset
    """
...
class TestCounselorMeetingMessage(TestCase):
    """ Test creating and sending a message for a counselor meeting (as a counselor)
        python manage.py test sncounseling.tests.test_counselor_meetings:TestCounselorMeetingMessage
    """
...
class TestEventTypes(TestCase):
    ...
    python manage.py test sncounseling.tests.test_counselor_meetings:TestEventTypes -s
    """
