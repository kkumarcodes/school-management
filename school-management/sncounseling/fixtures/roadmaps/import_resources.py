...
from snresources.models import ResourceGroup

path = f"{settings.BASE_DIR}/sncounseling/fixtures/roadmaps/2_21/resources.csv"
with open(path) as f:
...
path = f"{settings.BASE_DIR}/sncounseling/fixtures/roadmaps/2_21/tasks_resources.csv"
