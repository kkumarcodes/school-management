...
def parse_roadmap(roadmap_file, all_content):
    path = f"{settings.BASE_DIR}/cwcounseling/fixtures/roadmaps/7_21/{roadmap_file}.csv"
    write_path = f"{settings.BASE_DIR}/cwcounseling/fixtures/roadmaps/7_21/parsed/{roadmap_file}_parsed.csv"
...
containing_dir = f"{settings.BASE_DIR}/cwcounseling/fixtures/roadmaps/7_21/"
