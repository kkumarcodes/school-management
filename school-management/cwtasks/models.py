...
from cwuniversities.constants import applications
...
class Task(CWModel):
    ...
    resources = models.ManyToManyField("cwresources.Resource", related_name="tasks")
    ...
    diagnostic = models.ForeignKey(
        "cwtutoring.Diagnostic", related_name="tasks", null=True, blank=True, on_delete=models.CASCADE
    )
    # If this task is to complete a form
    form = models.ForeignKey("cwtasks.Form", related_name="tasks", null=True, blank=True, on_delete=models.CASCADE)
    ...
    student_university_decisions = models.ManyToManyField(
        "cwuniversities.StudentUniversityDecision", related_name="tasks", blank=True
    )
    ...
    counselor_meetings = models.ManyToManyField("cwcounseling.CounselorMeeting", related_name="tasks", blank=True)
    ...
    counselor_meeting_template = models.ForeignKey(
        "cwcounseling.CounselorMeetingTemplate", related_name="+", blank=True, null=True, on_delete=models.SET_NULL
    )

    task_template = models.ForeignKey(
        "cwtasks.TaskTemplate", related_name="tasks", blank=True, null=True, on_delete=models.SET_NULL
    )
...
class TaskTemplate(CWModel):
    ...
    counselor_meeting_template = models.ForeignKey(
        "cwcounseling.CounselorMeetingTemplate",
    ...
    roadmap = models.ForeignKey(
        "cwcounseling.Roadmap", null=True, blank=True, on_delete=models.SET_NULL, related_name="task_templates",
    )
    ...
    derived_from_task_template = models.ForeignKey(
        "cwtasks.TaskTemplate", related_name="derived_task_templates", null=True, blank=True, on_delete=models.PROTECT
    )
    ...
    resources = models.ManyToManyField("cwresources.Resource", related_name="task_templates", blank=True)
    diagnostic = models.ForeignKey(
        "cwtutoring.Diagnostic", related_name="tasks_templates", null=True, blank=True, on_delete=models.CASCADE,
    )
    form = models.ForeignKey(
        "cwtasks.Form", related_name="task_templates", null=True, blank=True, on_delete=models.CASCADE
    )
    ...
    # Check out the "Tasks and Student University Decisions" section of cwcounseling/README
...
class Form(CWModel):
    ...
    university = models.ForeignKey(
        "cwuniversities.University", related_name="forms", null=True, blank=True, on_delete=models.SET_NULL,
    )
    created_by = models.ForeignKey(
...
class FormSubmission(CWModel):
    ...
    form = models.ForeignKey(
        "cwtasks.Form", related_name="form_submissions", null=True, blank=True, on_delete=models.SET_NULL,
    )
    task = models.OneToOneField(
        "cwtasks.Task", related_name="form_submission", blank=True, null=True, on_delete=models.SET_NULL,
    )
...
class FormField(CWModel):
    ...
    form = models.ForeignKey("cwtasks.Form", related_name="form_fields", null=True, on_delete=models.SET_NULL)
...
class FormFieldEntry(CWModel):
    ...
    form_submission = models.ForeignKey(
        "cwtasks.FormSubmission", related_name="form_field_entries", null=True, on_delete=models.SET_NULL
    )
    form_field = models.ForeignKey("cwtasks.FormField", related_name="form_field_entries", on_delete=models.CASCADE)
