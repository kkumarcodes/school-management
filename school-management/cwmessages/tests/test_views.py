"""
  python manage.py test cwmessages.tests.test_views
...
class TestChatConversationTokenView(TestCase):
    """ python manage.py test cwmessages.tests.test_views:TestChatConversationTokenView """
...
class TestTwilioWebhook(TestCase):
    """ python manage.py test cwmessages.tests.test_views:TestTwilioWebhook """
    ...
    def test_counselor_forward_student_message_notification(self):
        """ Test to ensure that new messages from students are forwarded to counselor via SMS, if counselor
            has SMS enabled
            python manage.py test cwmessages.tests.test_views:TestTwilioWebhook.test_counselor_forward_student_message_notification
        """
        MESSAGE = "Hey!"
        data = {
