""" Test snresources.utilities
    python manage.py test snresources.tests.test_permissions
"""
...
from sntutoring.models import Diagnostic, GroupTutoringSession, StudentTutoringSession
