""" python manage.py test snresources.tests.test_views
"""
import json
...
from snresources.utilities.resource_permission_manager import get_resources_for_user
...
class TestResourcePermissionManager(TestCase):
    ...
    def test_get_resource_view(self):
        """ This view is also tested in snresources.tests.test_permissions.
...
class TestResourceGroupViewset(TestCase):
    """ python manage.py test snresources.tests.test_views:TestResourceGroupViewset """
...
class TestResourceViewset(TestCase):
    """ Test CRUD actions and the plethora of edge cases and restrictions
        ...
        python manage.py test snresources.tests.test_views:TestResourceViewset
    """
