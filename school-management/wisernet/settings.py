"""
Django settings for wisernet project.
...
WSGI_APPLICATION = 'wisernet.wsgi.application'
...
PROMPT_API_USERNAME = os.environ.get("PROMPT_API_USERNAME", "wisernet")
PROMPT_API_PASSWORD = os.environ.get("PROMPT_API_PASSWORD", "wisernet")
