    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('counselor_meeting_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='task_templates', to='sncounseling.counselormeetingtemplate')),
                ...
                ('derived_from_task_template', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='derived_task_templates', to='sntasks.tasktemplate')),
            ],
            options={
                'abstract': False,
            },
